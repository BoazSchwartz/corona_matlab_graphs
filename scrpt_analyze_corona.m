...
list_cntrs_forgotten = {'Germany', 'Austria', 'Belgium', 'Netherlands', 'Denmark'};
...
for idx = 1: length(list_countries_to_plot)
    ...
    [data_idx, dates] = filter_data_by_country(...
        str_country, crn_txt, crn_data);
...
% plot the data
plot_all(dates_all, data_all, pop_all, ...
    list_countries_to_plot, what_to_plot);
...
function plot_all(dates_all, data_all, pop_all, ...
    list_countries_to_plot, what_to_plot)
...
if strcmp(what_to_plot, 'total_cases')
    str_ylabel = 'one confirmed case out of...';
elseif strcmp(what_to_plot, 'total_deaths')
